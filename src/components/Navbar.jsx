  ...
  return (
    <>
      <nav className="w-full h-12 mb-10 flex items-center justify-between py-3">
        <div className="flex flex-shrink-0 items-center">PORTFOLIO</div>
        <div className="m-8 flex items-center justify-center gap-5 cursor-pointer z-0">
          ...
          <a
            href="https://github.com/ZweThuta"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/share/15QmB6QSQj/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://t.me/Hermez27"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaTelegram className="text-2xl" /> {/* Increased icon size */}
          </a>
        </div>
      </nav>
    </>
